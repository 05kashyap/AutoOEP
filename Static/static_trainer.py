...
# Import inference utilities (support both package and script execution)
try:
    from Static.static_inference import load_model_and_metadata, predict_cheating, demonstrate_prediction
except Exception:
    from static_inference import load_model_and_metadata, predict_cheating, demonstrate_prediction
